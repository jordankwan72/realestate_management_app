            ...
            {filteredApplications
              ...
              .map((application) => (
                <ApplicationCard
                  ...
                  userType="manager"
                >
                  <div className="flex justify-between gap-5 w-full pb-4 pl-4 pr-4">
                    ...
                    <div className="flex gap-2">
                      <Link
                        ...
                        className={`bg-white border border-gray-300 text-gray-700 pt-2 pb-2 pl-4 pr-4 
                      ...
                      {application.status === "Pending" && (
                        <>
                          <button
                            className="pl-4 pr-4 pb-2 pt-2 text-sm text-white bg-green-600 rounded hover:bg-green-500"
                            onClick={() =>
                          ...
                          <button
                            className="pl-4 pr-4 pb-2 pt-2 text-sm text-white bg-red-600 rounded hover:bg-red-500"
                            onClick={() =>
                      ...
                      {application.status === "Denied" && (
                        <button
                          className={`bg-gray-800 text-white pt-2 pb-2 pl-4 pr-4 rounded-md flex items-center
