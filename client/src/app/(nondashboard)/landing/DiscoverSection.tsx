...
const DiscoverSection = () => {
  return (
    <motion.div
      ...
      className="pt-12 pb-12 bg-white mb-16"
    >
      <div className="max-w-6xl xl:max-w-7xl mx-auto pl-6 pr-6 sm:pl-8 sm:pr-8 lg:pl-12 lg:pr-12 xl:pl-16 xl:pr-16">
        ...
        <div className="grid grid-col-1 md:grid-cols-3 gap-8 lg:gap-12 xl:gap-16 text-center">
          {[
            {
...
const DiscoverCard = ({
  ...
  <div className="pl-4 pr-4 pt-12 pb-12 shadow-lg rounded-lg bg-primary-50 md:h-72">
