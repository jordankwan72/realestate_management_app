...
const FiltersBar = () => {
  ...
  return (
    <div className="flex justify-between items-center w-full pt-5 pb-5">
      {/* Filters */}
      ...
      <div className="flex justify-between items-center gap-4 p-2">
        <div className="flex border rounded-xl">
          <Button
            variant="ghost"
            className={cn(
              "pl-3 pr-3 pt-1 pb-1 rounded-none rounded-l-xl hover:bg-primary-600 hover:text-primary-50",
          ...
          <Button
            variant="ghost"
            className={cn(
              "pl-3 pr-3 pt-1 pb-1 rounded-none rounded-r-xl hover:bg-primary-600 hover:text-primary-50",
