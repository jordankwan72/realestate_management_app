...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center w-full pt-3 pb-3 pl-8 pr-8 bg-primary-700 text-white">
        ...
        {!isDashboardPage && (
          <p className="text-primary-200 hidden md:block">
            Discover your dream home with our advanced search.
          </p>
        )}
          ...
          {authUser ? (
            ...
            <>
              ...
              <Link href="/signup">
                <Button
                  variant="secondary"
                  className="bg-secondary-600 hover:bg-white hover:text-primary-500 rounded-lg"
                >
                  Sign Up
                </Button>
              </Link>
