...
const ApplicationCard = ({
  ...
  return (
    <div className="border rounded-xl overflow-hidden shadow-sm bg-white mb-4">
      <div className="flex flex-col lg:flex-row  items-start lg:items-center justify-between pl-6 pr-6 md:pl-4 md:pr-4 pt-6 pb-6 gap-6 lg:gap-4">
        ...
        {/* Status Section */}
        <div className="flex flex-col justify-between w-full lg:basis-2/12 lg:h-48 pt-2 pb-2 gap-3 lg:gap-0">
          <div>
            <div className="flex justify-between items-center">
              <span className="text-gray-500">Status:</span>
              <span
                className={`pl-2 pr-2 pt-1 pb-1 ${statusColor} text-white rounded-full text-sm`}
              >
                {application.status}
              </span>
            </div>
        ...
        <div className="flex flex-col justify-start gap-5 w-full lg:basis-3/12 lg:h-48 pt-2 pb-2">
          <div>
